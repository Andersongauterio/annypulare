...
import br.com.annypularebackend.services.InsumoService;
...
public class InsumoResource {
	...
	public ResponseEntity<Page<InsumoDTO>> findAll(Pageable pageable) {
		...
		Page<InsumoDTO> list = service.findAllPaged(pageable);
	...
	@PostMapping
	public ResponseEntity<InsumoDTO> insert(@RequestBody InsumoDTO dto) {
